...
from ..detect.utils import detect_objects, compare_images
import cv2
...
def landing(request):
    return render(request, 'detection/landing.html')  # Ensure your HTML file is named 'landing_page.html' and is in the templates folder.
